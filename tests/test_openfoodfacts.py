...
def test_parse_product():
    result = parse_product({"status": 1, "product": {"product_name": "Milk", "brands": "Example", "quantity": "1 L", "categories_tags": ["en:milk"], "countries_tags": ["en:netherlands"], "image_front_url": "https://example.test/a.jpg"}}, "4006381333931")
